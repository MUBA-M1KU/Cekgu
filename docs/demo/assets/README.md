...
| `hero-problem.jpg` | 02, problem  | 1920x1080, JPEG | A painterly, cinematic illustration, wide format, of a teacher seen from behind at a desk late at night, a warm desk lamp, a tall stack of exam papers, the top paper with one answer circled in red ink, muted dark navy tones that fade to near-black across the left half so text can sit there, the lamp and papers in the right half, no faces, no readable text, no logos.            |
| `hero-user.png`    | 03, the user | 800x800         | A painterly portrait of a Malaysian woman in her mid-thirties, a tutor, standing in a bright tuition classroom holding a printed quiz, warm afternoon light through a window, soft focus background, no readable text, no logos, square crop centred on the face and shoulders.                                                                                                             |
