...
under the exact name and the deck picks it up on the next open; nothing else to run. A third, `hero-user.jpg`, went with
the persona slide when the deck was re-cut for the 3-minute pitch.
