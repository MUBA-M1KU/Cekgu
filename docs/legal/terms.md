...
Deleting a private record hides it from your library but leaves a stored copy. Read the [privacy notice](privacy.md) for
the demo's deletion limits before adding content.
...
Publication requires the [application-length copyright notice][sample-terms] in full. Its inclusion in the final app
copy remains a release review item; the short attribution above does not replace it.
