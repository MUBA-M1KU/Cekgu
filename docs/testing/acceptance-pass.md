...
Desktop acceptance is complete for normal use. Keep [#48](https://github.com/MUBA-M1KU/Cekgu/issues/48) open only while
#189 is open, because a live check can be delayed by GonkaRouter rate limiting or a stranded claim. Mobile rows are
