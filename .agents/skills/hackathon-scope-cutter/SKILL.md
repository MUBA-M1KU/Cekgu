...
description: >-
  Cut a feature set down to what ships by the 5 Sept submission deadline while preserving demo impact. Use proactively whenever a plan or feature list grows past the days remaining.
---
